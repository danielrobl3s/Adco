$certificateSubjectName = "CN=User Name"
...
dotnet publish -f net7.0-windows10.0.19041 -c Release /p:PackageCertificateThumbprint=$cert /p:GenerateAppxPackageOnBuild=true /p:AppxPackageSigningEnabled=true