...
class formRegisterDesigner:
    ...
    def __init__(self):
        ...
        utl.center_window(self.window, 600, 450)
        ...
        frame_logo = tk.Frame(self.window, bd=0, width=300, relief=tk.SOLID, padx=1, pady=1, bg='#F87474')
        ...
        title = tk.Label(frame_form_top, text="Register", font=('Helvetica', 100), fg="black", bg='white', pady=100)
        ...
        #Confirmation label
        etiqueta_confirmacion = tk.Label(frame_form_fill, text="Password", font=('Times', 14), fg="black",bg="#DADCB5", anchor="w")
        ...
        #submit button
        submit = tk.Button(frame_form_fill, text="Register", font=('Times', 14, BOLD), bg='#fff', bd=0, fg="black", command=self.verification)
        submit.pack(fill=tk.X, padx=20, pady=20)
        submit.bind("<Return>", (lambda event: self.verification()))

        #Register user button
        submit = tk.Button(frame_form_fill, text="Register", font=('Times', 14, BOLD), bg='#fff', bd=0, fg="black", command=self.register)
        submit.pack(fill=tk.X, padx=20, pady=20)
        submit.bind("<Return>", (lambda event: self.register()))
